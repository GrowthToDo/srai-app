...
// Single source of truth for the footer version — package.json.version is
// kept in lockstep with CHANGELOG.md's latest entry (a hardcoded string here
// once drifted 9 patch versions behind).
    ...
    <>
      ...
      >
        <div className="flex h-14 items-center border-b px-4">
          <BrandMark size={26} className="text-lg" />
        </div>
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {counts &&
                        BADGE_COUNTS[item.href] &&
                        BADGE_COUNTS[item.href](counts) > 0 && (
                          <span
                            className={cn(
        ...
        <div className="border-t p-4">
          ...
          <div className="mb-2 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground/50">v{appVersion}</p>
            </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      window.dispatchEvent(
                        new Event("open-keyboard-shortcuts"),
                      );
                      setHelpOpen(false);
                    }}
                  >
