...
export async function seedDatabase(
  ...
  for (const h of holidays) {
    db.insert(schema.publicHoliday)
      .values({ id: uuid(), ...h })
      .run();
  }
  ...
  const staffData = [
    ...
    // Expert/Charge RNs (Level 5)
    {
      ...
      reliabilityRating: 5,
      certifications: ["CCRN", "BLS", "ACLS", "TNCC"],
      email: "maria.garcia@cah.local",
      phone: "512-555-0101",
      homeUnit: "ICU",
      crossTrainedUnits: ["ER"],
      weekendExempt: false,
    },
    {
      id: uuid(),
    ...
    },
    {
      ...
      email: "david.martinez@cah.local",
      phone: "512-555-0106",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // Advanced Beginner RN (Level 2)
    {
      ...
      reliabilityRating: 3,
      certifications: ["BLS"],
      email: "ashley.johnson@cah.local",
      phone: "512-555-0108",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // Orientee RN (Level 1) - Needs preceptor
    {
      ...
      reliabilityRating: 3,
      certifications: ["BLS"],
      email: "robert.taylor@cah.local",
      phone: "512-555-0109",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "New grad orientee - requires Level 5 preceptor",
    },
    // ICU LPN
    {
      id: uuid(),
      ...
      email: "jessica.rodriguez@cah.local",
      phone: "512-555-0110",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // ICU CNAs
    {
      ...
      email: "jennifer.white@cah.local",
      phone: "512-555-0111",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // === PART-TIME STAFF (4 members) ===
    {
      ...
      reliabilityRating: 4,
      certifications: ["BLS", "ACLS"],
      email: "kevin.thomas@cah.local",
      phone: "512-555-0113",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "Works Fri-Sun only",
    },
    {
      id: uuid(),
      firstName: "Rachel",
    ...
    },
    {
      ...
      reliabilityRating: 3,
      certifications: ["BLS"],
      email: "steven.lee@cah.local",
      phone: "512-555-0115",
      homeUnit: "ICU",
      crossTrainedUnits: ["Med-Surg"],
      weekendExempt: false,
    },
    {
      id: uuid(),
    ...
    // === PER DIEM / PRN STAFF (4 members) ===
    {
      ...
      reliabilityRating: 4,
      certifications: ["BLS", "ACLS"],
      email: "patricia.clark@cah.local",
      phone: "512-555-0117",
      homeUnit: "ICU",
      crossTrainedUnits: ["ER"],
      weekendExempt: false,
      notes: "Retired RN, picks up 2-3 shifts/month",
    },
    {
      id: uuid(),
      firstName: "Mark",
    ...
    // === FLOAT POOL (3 members) ===
    {
      ...
      reliabilityRating: 4,
      certifications: ["BLS", "ACLS", "PALS"],
      email: "amanda.walker@cah.local",
      phone: "512-555-0121",
      homeUnit: null,
      crossTrainedUnits: ["ICU", "ER", "Med-Surg"],
      weekendExempt: false,
      notes: "Float pool - highly flexible",
    },
    {
      id: uuid(),
    ...
    },
    {
      ...
      reliabilityRating: 4,
      certifications: ["CNA", "BLS"],
      email: "stephanie.scott@cah.local",
      phone: "512-555-0123",
      homeUnit: null,
      crossTrainedUnits: ["ICU", "ER", "Med-Surg"],
      weekendExempt: false,
      notes: "Float pool CNA",
    },
    ...
    // === AGENCY STAFF (3 members) ===
    {
      ...
      reliabilityRating: 3,
      certifications: ["BLS", "ACLS"],
      email: "brian.turner@agency.com",
      phone: "512-555-0124",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "Agency - 13-week contract ending March 2026",
    },
    {
      id: uuid(),
      firstName: "Kimberly",
      ...
      reliabilityRating: 2,
      certifications: ["BLS"],
      email: "kim.phillips@agency.com",
      phone: "512-555-0125",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "Agency - temporary coverage",
    },
    {
      id: uuid(),
      firstName: "Jason",
      ...
      reliabilityRating: 3,
      certifications: ["CNA", "BLS"],
      email: "jason.campbell@agency.com",
      phone: "512-555-0126",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // === STAFF WITH SPECIAL STATUS (2 members) ===
    {
      ...
      email: "elizabeth.mitchell@cah.local",
      phone: "512-555-0127",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: true,
      notes: "Weekend exempt - ADA accommodation for childcare",
    },
    {
      id: uuid(),
      firstName: "William",
      ...
      reliabilityRating: 2,
      certifications: ["BLS", "ACLS"],
      email: "william.roberts@cah.local",
      phone: "512-555-0128",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "Frequent callouts - on performance improvement plan",
      flexHoursYearToDate: 24,
    },
    ...
    // Night charge backup — Level 4, charge qualified (James Wilson is the only night charge; this gives resilience)
    {
      ...
      reliabilityRating: 4,
      certifications: ["CCRN", "BLS", "ACLS"],
      email: "sophia.patel@cah.local",
      phone: "512-555-0129",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
      notes: "Night charge backup - Level 4",
    },
    // Second LPN (part-time) — only Jessica Rodriguez is an LPN; adds shift flexibility
    {
      ...
      isChargeNurseQualified: false,
      reliabilityRating: 4,
      certifications: ["LPN", "BLS", "ACLS"],
      email: "marcus.thompson@cah.local",
      phone: "512-555-0130",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
    ...
    // Charge-qualified float RN — adds a charge-nurse option to the float pool
    {
      ...
      isChargeNurseQualified: true,
      reliabilityRating: 5,
      certifications: ["CCRN", "BLS", "ACLS", "PALS"],
      email: "carlos.rivera@cah.local",
      phone: "512-555-0132",
      homeUnit: null,
      crossTrainedUnits: ["ICU", "ER", "Med-Surg"],
      weekendExempt: false,
      notes: "Float pool - charge qualified, covers all units",
    },
    // Extra CNA (full-time) — Yellow/Red census tiers require 2 CNAs; currently only 2 FT CNAs exist
    {
      ...
      reliabilityRating: 3,
      certifications: ["CNA", "BLS"],
      email: "natalie.brooks@cah.local",
      phone: "512-555-0133",
      homeUnit: "ICU",
      crossTrainedUnits: [],
      weekendExempt: false,
  ...
  for (let i = 0; i < staffData.length; i++) {
    const s = staffData[i];
    db.insert(schema.staffPreferences)
      .values({
        staffId: s.id,
  ...
  const rules = [
    // Hard rules
    {
      ...
      description: "Each shift must meet the minimum staff count",
      parameters: { evaluator: "min-staff" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "hard" as const,
      category: "staffing" as const,
      description: "Shifts requiring a charge nurse must have one assigned",
      parameters: { evaluator: "charge-nurse" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      category: "staffing" as const,
      description:
        "RN-to-patient ratio must not exceed the census band maximum (default 2:1). Only RNs count — LPNs and CNAs are support staff, not substitutes. Only enforced for shifts using a numeric census value; census-band shifts satisfy the ratio by construction.",
      parameters: { evaluator: "patient-ratio" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      description:
        "Staff must have at least 10 hours of rest between consecutive shifts",
      parameters: { evaluator: "rest-hours", minRestHours: 10 },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      category: "rest" as const,
      description:
        "Staff cannot work more than 5 consecutive days without a day off",
      parameters: { evaluator: "max-consecutive", maxConsecutiveDays: 5 },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      description:
        "Staff assigned to ICU or ER shifts must hold ICU Competency Level 2 or above. Level 1 orientees are blocked from ICU/ER shifts regardless of preceptor availability.",
      parameters: { evaluator: "icu-competency", minLevel: 2 },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      category: "skill" as const,
      description:
        "A Level 1 orientee on any non-ICU/ER shift requires a Level 5 RN on the same shift as preceptor. Level 1 orientees cannot be placed on ICU or ER shifts under any circumstances (enforced by the ICU/ER Competency rule).",
      parameters: { evaluator: "level1-preceptor", minPreceptorLevel: 5 },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      category: "skill" as const,
      description:
        "Level 2 staff working in ICU or ER must have at least one Level 4 or above nurse on the same shift for direct supervision",
      parameters: { evaluator: "level2-supervision", minSupervisorLevel: 4 },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      parameters: { evaluator: "no-overlapping-shifts" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      parameters: { evaluator: "prn-availability" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      parameters: { evaluator: "staff-on-leave" },
      weight: 1.0,
    },
    {
      id: uuid(),
      ...
      category: "rest" as const,
      description:
        "A staff member may hold at most 1 on-call shift per week and 1 on-call weekend per month. Enforced during auto-generation, swap approval, and open-shift candidate ranking.",
      parameters: {
    ...
    },
    {
      ...
      ruleType: "hard" as const,
      category: "rest" as const,
      description: "Staff cannot work more than 60 hours in 7 days",
      parameters: { evaluator: "max-hours-60", maxHours: 60 },
      weight: 1.0,
    },
    // Soft rules
    {
      ...
      description: "Penalty for overtime (>40h) and extra hours",
      parameters: {
        evaluator: "overtime-v2",
        actualOtPenaltyWeight: 1.0,
        extraHoursPenaltyWeight: 0.3,
      },
      weight: 8.0,
    },
    {
      ...
      ruleType: "soft" as const,
      category: "preference" as const,
      description: "Match staff to their preferred shifts",
      parameters: { evaluator: "preference-match" },
      weight: 5.0,
    },
    {
      id: uuid(),
      ...
      description: "Staff must work minimum weekend shifts per period",
      parameters: { evaluator: "weekend-count" },
      weight: 7.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "soft" as const,
      category: "fairness" as const,
      description: "Penalize >2 consecutive weekends",
      parameters: { evaluator: "consecutive-weekends" },
      weight: 6.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "soft" as const,
      category: "fairness" as const,
      description: "Fair distribution of holiday shifts",
      parameters: { evaluator: "holiday-fairness" },
      weight: 7.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "soft" as const,
      category: "skill" as const,
      description: "Each shift should have mix of experience levels",
      parameters: { evaluator: "skill-mix" },
      weight: 3.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "soft" as const,
      category: "preference" as const,
      description: "Minimize floating staff to other units",
      parameters: { evaluator: "float-penalty" },
      weight: 4.0,
    },
    {
      id: uuid(),
      ...
      ruleType: "soft" as const,
      category: "skill" as const,
      description: "Distribute charge nurses across shifts",
      parameters: { evaluator: "charge-clustering" },
      weight: 4.0,
    },
    {
      id: uuid(),
      name: "Weekend-Exempt Staff Protection",
      ruleType: "soft" as const,
      category: "preference" as const,
      description:
        "Weekend-exempt staff should only be scheduled on weekends as a last resort",
      parameters: { evaluator: "weekend-exempt" },
      weight: 4.0,
    },
  ];
  ...
  db.insert(schema.schedule)
    .values({
      ...
      status: "draft",
      notes:
        "6-week scheduling period for ICU unit. Includes Presidents' Day holiday.",
    })
    .run();
  ...
  const leaveRequests = [
    {
      staffId: staffData[4].id,
      leaveType: "vacation" as const,
      startDate: "2026-02-09",
      endDate: "2026-02-13",
      status: "approved" as const,
      notes: "Family vacation - planned 6 months ago",
    },
    {
      staffId: staffData[6].id,
    ...
    {
      staffId: staffData[3].id,
      leaveType: "personal" as const,
      startDate: "2026-02-23",
      endDate: "2026-02-23",
      status: "approved" as const,
      notes: "Child's school event",
    },
    {
      ...
      endDate: "2026-04-30",
      status: "approved" as const,
      notes: "Maternity leave - 8 weeks",
    },
    {
      staffId: staffData[7].id,
  ...
  for (const leave of leaveRequests) {
    db.insert(schema.staffLeave)
      .values({ id: uuid(), ...leave })
      .run();
  }
  console.log(
    `✓ Created ${leaveRequests.length} leave requests (4 approved, 2 pending)`,
  );
  ...
  db.insert(schema.prnAvailability)
    .values({
  ...
  const chargeRNs = staffData.filter(
    (s) => s.isChargeNurseQualified && s.role === "RN",
  );
  const level4PlusRNs = staffData.filter(
    (s) =>
      s.role === "RN" && s.icuCompetencyLevel >= 4 && !s.isChargeNurseQualified,
  );
  const level3RNs = staffData.filter(
    (s) => s.role === "RN" && s.icuCompetencyLevel === 3,
  );
  ...
  for (const c of callouts) {
    db.insert(schema.callout)
      .values({
        ...
        escalationStepsTaken:
          c.status === "filled"
            ? [
                {
                  step: c.replacementSource || "float",
                  attempted: true,
                  result: "filled",
  ...
  console.log(
    `✓ Created ${callouts.length} callouts (3 filled, 1 unfilled approved, 1 open)`,
  );
  ...
  for (const swap of swapRequests) {
    db.insert(schema.shiftSwapRequest)
      .values({
        id: uuid(),
        ...
        notes: swap.notes,
        reviewedAt:
          swap.status === "approved" ? new Date().toISOString() : null,
        reviewedBy: swap.status === "approved" ? "nurse_manager" : null,
      })
      .run();
  }
  console.log(
    `✓ Created ${swapRequests.length} swap requests (1 approved, 2 pending)`,
  );
  ...
  const auditEntries = [
    {
      ...
      description: "Schedule created for Feb-Mar 2026",
      performedBy: "nurse_manager",
    },
    {
      entityType: "assignment" as const,
      entityId: assignmentIds[0].id,
      action: "manual_assignment" as const,
      description: "Manually assigned Maria Garcia as charge nurse",
      performedBy: "nurse_manager",
    },
    {
      entityType: "callout" as const,
      entityId: uuid(),
      action: "callout_logged" as const,
      description: "Callout logged for sick call",
      performedBy: "nurse_manager",
    },
    {
      entityType: "callout" as const,
      ...
      description: "Callout filled with float pool nurse",
      performedBy: "nurse_manager",
    },
    {
      entityType: "swap_request" as const,
      entityId: uuid(),
      action: "swap_approved" as const,
      description: "Shift swap approved between two nurses",
      performedBy: "nurse_manager",
    },
    {
      entityType: "leave" as const,
      entityId: uuid(),
      action: "leave_approved" as const,
      description: "Vacation leave approved for Emily Davis",
      performedBy: "nurse_manager",
    },
    {
      entityType: "shift" as const,
      entityId: shifts[3].id,
      action: "acuity_changed" as const,
      description: "Acuity changed from green to yellow due to admissions",
      performedBy: "charge_nurse",
    },
  ];

  for (const entry of auditEntries) {
    db.insert(schema.exceptionLog)
      .values({
        id: uuid(),
        ...entry,
      })
